...
<template>
    <div class="container">
        <portfolio-post title="Masterrow">

            <p class="paragraph" slot="whatsIsThis">
            ...
            <p class="paragraph" slot="necessity">
            ...
            <p class="paragraph" slot="competitor">
            ...
            <p class="paragraph" slot="concept">
            ...
            <p class="paragraph" slot="development">
